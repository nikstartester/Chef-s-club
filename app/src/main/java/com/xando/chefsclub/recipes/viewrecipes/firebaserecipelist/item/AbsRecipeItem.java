...
public abstract class AbsRecipeItem extends AbstractItem<AbsRecipeItem, AbsRecipeItem.ViewHolder> implements LifecycleObserver {
    ...
    @Nullable
    private AbsRecipeItem.ViewHolder mViewHolder;
    @Nullable
    ...
    AbsRecipeItem(@Nullable RecipeData recipeData, @Nullable LifecycleOwner lifecycleOwner) {
