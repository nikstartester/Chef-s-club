...
public class IngredientsConverter {
    ...
    @TypeConverter
    public static String fromIngredientsList(List<String> ingredientsList) {

        return stringConverter(ingredientsList);

    }

    @TypeConverter
    public static List<String> toIngredientsList(String data) {
