...
public abstract class DataUploaderService<Data extends BaseData> extends Service {
    ...
    public static final String ACTION_RESPONSE = "com.example.nikis.bludogramfirebase.DataWorkers.action.RESPONSE";
    public static final String EXTRA_RESOURCE = "com.example.nikis.bludogramfirebase.DataWorkers.extra.RESOURCE";
    protected static final String EXTRA_DATA = "com.example.nikis.bludogramfirebase.DataWorkers.extra.DATA";
    protected static final String EXTRA_ACTIONS = "com.example.nikis.bludogramfirebase.DataWorkers.extra.Action";
